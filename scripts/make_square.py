...
Usage:
  python3 scripts/make_square.py <image_path>
"""
import sys
...
def make_square(image_path: Path):
    ...
    try:
        ...
        # If the image is a JPEG, flatten it with a white background
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python3 scripts/make_square.py <image_path>")
        sys.exit(1)
